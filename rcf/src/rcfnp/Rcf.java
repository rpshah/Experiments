...
public class Rcf {
    ...
    public void main(int userValue) {
        ...
        ArrayList<SortedVector> V = r.getSortedVectors();
        ...
        ArrayList<PriorityQueue<SortedVector>> Q = constructor.getKnnQueues(V,P,K);
        
        int []similarityCounter = constructor.getSimilarityCounter();
        ArrayList<UserVector> userVector = r.getUserVector();
        ArrayList<MovieVector> movieVector = r.getMovieVector();
